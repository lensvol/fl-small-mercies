...
def main():
    ...
    hardcoded_items = OrderedDict({
        ...
        "Infernal Machine": [141229, 66.00],
        "Glass Gazette": [141285, 2.90],
        "Sky-Story": [129586, 141.85],
        "Screaming Map: Left-Hand Half": [955, 15.00],
        "Screaming Map: Right-Hand Half": [981, 25.00],
        "Memory of a Much Lesser Self": [141779, 2.50],
        "Holy Sanguinarine Ointment": [142909, 0.50],
        "Discriminating Aconite": [142911, 2.50],
        "Rubbery Skull": [811, 6.00],
        "Beatrice's Taper-nut": [142237, 5.00],
        "Parabolan Orange-apple": [140962, 12.50],
        "Remains of a Pinewood Shark": [141324, 12.50],
        "Hellworm Milk": [143051, 62.50],
        "A Recipe for Zzoup": [106688, 17.50],
        "Lost Research Assistant": [143107, 12.50],
        "Perfumed Gunpowder": [140779, 2.50],
        "Khaganian Lightbulb": [142728, 0.10],
        ...
        "Distillation of Retribution": [141764, 312.50],
        "Memory of Discordance": [141385, 12.50],
        "Discordant Soul": [141772, 62.50],
    })
