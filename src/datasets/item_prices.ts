...
const ITEM_PRICES_BY_NAME: Map<string, number> = new Map([
    ...
    ["A Blue and Shining Stone", 12.5],
    ["A Boxed Cat?", 0.1],
    ["A Headful of Picaresque Tales", 12.5],
    ["A Miniature Model Ship", 10 * 0.49],  // via Certifiable Scrap
    ["A Mislaid Diamond", 12.5],
    ["A Monstrous Orb", 6],
    ["A Partially Unwrapped Cat?", 0.5],
    ["A River In A Box", 32.5],
    ["A Sealed Copy of the Crimson Book", 625 * 2.50],  // via Touching Love Story
    ["A Seat at the Board", 1562.5],
    ["A Tasting Flight of Targeted Toxins", 1562.5],
    ...
    ["Ambiguous Eolith", 0.5],
    ["An Identity Uncovered!", 2.5],
    ["Anarchist's Sable", 6],
    ...
    ["Antique Mystery", 12.5],
    ["Apostate's Psalm", 2.5],
    ...
    ["Baptised Rattus Faber Corpse", 2.5],
    ["Basket of Rubbery Pies", 2.5],
    ["Bat with Attitude", 12.5],
    ["Battered Grey Overcoat", 6.4],
    ["Bazaar Permit", 12.5],
    ["Beguiling Mask", 62.5],
    ["Bejewelled Lens", 12.5],
    ...
    ["Bone Fragments", 0.01],
    ["Book of Hidden Bodies", 6],
    ["Bottle of Broken Giant 1844", 2.5],
    ["Bottle of Fourth City Airag: Year of the Tortoise", 62.5],
    ["Bottle of Greyfields 1868 First Sporing", 0.2],
    ["Bottle of Greyfields 1879", 0.01],
    ["Bottle of Greyfields 1882", 0.02],
    ["Bottle of Morelways 1872", 0.1],
    ["Bottle of Strangling Willow Absinthe", 0.5],
    ["Bottled Oblivion", 0.01],
    ["Brass Ring", 12.5],
    ["Breath of the Void", 1560],
    ["Bright Brass Skull", 60],
    ["Brilliant Soul", 0.5],
    ["Bundle of Fourth City Rags", 0.3],
    ["Bundle of Glad Rags", 0.2],
    ["Bundle of Ragged Clothing", 0.01],
    ["Captivating Ballad", 62.5],
    ["Carnelian Sapphire Pendant", 75],
    ["Cartographer's Hoard", 312.5],
    ["Carved Ball of Stygian Ivory", 2.5],
    ["Caustic Apocryphon", 250 * 0.05],  // via Stuiver
    ["Cave-Aged Code of Honour", 12.50],  // via Legal Document
    ["Celebrated Short Story", 130],
    ["Cellar of Wine", 12.5],
    ["Cheerful Goldfish", 0.04],
    ["Chimerical Archive", 62.5],
    ["Classic Short Story", 180],
    ["Clockwork Drownie", 5 * 0.49],  // via Certifiable Scrap
    ["Collection of Curiosities", 6],
    ["Compelling Short Story", 30],
    ["Competent Short Story", 10],
    ["Complaisant Frost-Moth", 5],
    ["Comprehensive Bribe", 12.5],
    ["Compromising Document", 0.5],
    ["Conceptual Breakthrough in Currency Design", 12.5],
    ["Copper Cipher Ring", 37.5],
    ["Correspondence Plaque", 0.5],
    ["Corresponding Ocelot", 35],
    ["Corsetted Dress", 12.5],
    ["Coruscating Soul", 312.5],
    ["Crackling Device", 62.5],
    ["Crate of Incorruptible Biscuits", 2.5],
    ["Cryptic Clue", 0.02],
    ["Cryptobotanical Rosette", 0.5],
    ["Dark-Dewed Cherry", 0.7],
    ["Dazed Raven Advisor", 6.4],
    ["Deep-zee Catch", 0.5],
    ["Deshrieked Mandrake", 6.4],
    ["Devilbone Die", 0.9],
    ["Devilish Fedora", 200],
    ["Devilish Probability Distributor", 62.5],
    ["Devilishly Slinky Evening Gown", 500 * 0.50],  // via Hinterland Scrip
    ["Devious Henchman", 12.5],
    ["Devious Raven Advisor", 90],
    ["Diary of the Dead", 60],
    ["Dignified Tailcoat", 12.5],
    ["Direful Reflection", 12.5],
    ["Dismal Victuals", 2.50],  // via Touching Love Story
    ["Distinguished Gentleman's Outfit", 62.5],
    ["Dove Mask Shard", 0.25],
    ["Dreadful Surmise", 312.5],
    ["Dreamy Raven Advisor", 9],
    ["Drop of Prisoner's Honey", 0.02],
    ["Dubious Testimony", 0.5],
    ["Eager Glove", 2.5],
    ["Edicts of the First City", 312.5],
    ["Elegant Emerald Gown", 62.5],
    ["Element of Dawn", 62.5],
    ["Elemental Secret", 312.5],
    ...
    ["Exceptional Short Story", 60],
    ["Exigent Note", 62.5],
    ["Exquisite Ivory Gown", 230.4],
    ["Extraordinary Hat", 312.5],
    ["Extraordinary Implication", 2.5],
    ["Extraordinary Short Story", 70],
    ["Eyeless Skull", 30],
    ...
    ["Flask of Abominable Salts", 0.1],
    ["Flawed Diamond", 0.12],
    ["Fluke Spine, Freely Given", 3.00],  // via Knotted Humerus
    ["Fluke-Core", 1560],
    ["Focused Albatross", 12.5],
    ...
    ["Fragment of White Gold", 0.4],
    ["Fragment of the Tragedy Procedures", 62.5],
    ["Fraught Research Assistant", 12.5],
    ...
    ["M. Demeaux's Advice for Captains: Commemorative Edition", 5],
    ["Magisterial Lager", 0.50],  // via Hinterland Scrip
    ["Magnificent Diamond", 12.5],
    ...
    ["Masterful Short Story", 80],
    ["Memory of Distant Shores", 0.5],
    ...
    ["Mirthless Compendium of Statistical Observations", 12.5],
    ...
    ["Mountain-sherd", 62.5],
    ["Mourning Candle", 2.5],
    ["Moves in the Great Game", 0.5],
    ["Much-Needed Gap", 125 * 0.50],  // via Assortment of Khaganian Coinage
    ["Muscaria Brandy", 2.5],
    ["Mystery of the Elder Continent", 0.5],
    ["Mystic Raven Advisor", 90],
    ["Neddy Suit", 6],
    ["Neo-Echo", 0.10],  // via Jasmine Leaves
    ["Nevercold Brass Sliver", 0.01],
    ["Nicatorean Relic", 2.5],
    ["Night on the Town", 2.5],
    ...
    ["Pair of Forgotten Spidersilk Slippers", 160],
    ["Pair of Hushed Spidersilk Slippers", 160],
    ["Pair of Iron Manacles", 0.4],
    ["Pair of Irrigo Goggles", 12.8],
    ...
    ["Palimpsest Scrap", 0.5],
    ["Parabola-Linen Frock", 230],
    ["Parabola-Linen Scrap", 62.5],
    ["Parabola-Linen Suit", 230],
    ["Parabolan Parable", 312.5],
    ["Partial Map", 2.5],
    ...
    ["Philosophical Raven Advisor", 40],
    ["Phosphorescent Scarab", 0.1],
    ["Piece of Rostygold", 0.01],
    ["Pirate Hat", 0.5],
    ["Poison-Tipped Umbrella", 225],
    ["Portfolio of Souls", 12.5],
    ["Pot of Venison Marrow", 0.5],
    ["Presbyterate Passphrase", 2.5],
    ["Preserved Surface Blooms", 2.5],
    ["Primaeval Hint", 62.5],
    ["Primordial Shriek", 0.02],
    ["Prison Shiv", 0.01],
    ["Prisoner's Mask", 0.04],
    ["Proscribed Material", 0.04],
    ["Puzzle-Damask Scrap", 12.5],
    ["Puzzling Map", 12.5],
    ...
    ["Rattus Faber Rifle", 2.5],
    ["Ratty Reliquary", 12.5],
    ["Ratwork Derringer", 250],
    ["Ratwork Mechanism", 250 * 0.05],  // via Stuiver
    ["Ratwork Watch", 230],
    ["Ravenglass Knife", 51.2],
    ["Ravenous Henchman", 28.8],
    ["Ray-Drenched Cinder", 312.5],
    ["Red-Feathered Pin", 35],
    ["Relatively Safe Zee Lane", 62.5],
    ["Relic of the Fifth City", 2.5],
    ["Relic of the Fourth City", 0.05],
    ["Relic of the Second City", 0.15],
    ["Relic of the Third City", 0.1],
    ["Reported Location of a One-Time Prince of Hell", 1560],
    ["Reprehensible Lizard", 0.2],
    ["Respectable Grey Gown", 14.4],
    ["Ridiculous Hat", 0.01],
    ["Ring of Stone", 0.3],
    ["Ripened Wheel of Hellworm Cheese", 62.5],
    ["Romantic Notion", 0.1],
    ["Roof-Chart", 50 * 0.05],  // via Stuiver
    ["Rookery Password", 60],
    ["Rostygold Ring", 6.25],
    ["Rough Gown", 0.2],
    ["Royal-Blue Feather", 0.5],
    ["Rubbery Associate", 0.2],
    ["Rubbery Conspirator", 0.01],
    ["Rubbery Euphonium", 3],
    ["Rumour of the Upper River", 2.5],
    ["Rumourmonger's Network", 1560],
    ["Rusted Stirrup", 0.1],
    ["Ruthless Henchman", 62.5],
    ["Salt Steppe Atlas", 62.5],
    ["Salt Weasel", 2.5],
    ["Sample of Lacreous Affection", 312.5],
    ["Sample of Roof-Drip", 2 * 0.05],  // via Stuiver
    ["Sap of the Cedar at the Crossroads", 125 * 0.50],  // via Hinterland Scrip
    ["Sapphire", 0.12],
    ["Sausage About Which No One Complains", 12.5],
    ["Scrap of Incendiary Gossip", 0.5],
    ["Scrap of Ivory Organza", 312.5],
    ["Scuttering Squad", 10],
    ["Searing Enigma", 62.5],
    ["Secluded Address", 0.5],
    ...
    ["Seven-Throated Warbler", 12.5],
    ["Shabby Opera Cloak", 0.2],
    ["Shard of Glim", 0.01],
    ["Shard of Lightless Glim", 0.01],  // via Piece of Rostygold
    ["Short Story", 2],
    ["Shrivelled Ball", 0.3],
    ["Sighting of a Parabolan Landmark", 0.1],
    ["Silent Soul", 12.5],
    ["Silk Scrap", 0.01],
    ["Silvered Cat's Claw", 0.1],
    ["Skyglass Knife", 3.2],
    ["Slavering Dream-Hound", 35],
    ["Smock of Four Thousand Three Hundred and Eight Pockets", 210],
    ["Sneak-Thief's Mask", 10],
    ["Snuffer's Face", 200],
    ["Sober Dress", 0.08],
    ["Solacefruit", 0.5],
    ...
    ["Starry-Eyed Scoundrel", 14],
    ["Starstone Demark", 312.5],
    ["Starved Expression", 10 * 0.05],  // via Stuiver
    ["Stolen Correspondence", 0.05],
    ["Stolen Kiss", 2.5],
    ["Storm-Threnody", 12.5],
    ["Strange-Shore Parabola Frock", 470],
    ["Strange-Shore Parabola Suit", 470],
    ["Strong-Backed Labour", 2.5],
    ["Sulky Bat", 0.2],
    ["Sumptuous Dandy's Outfit", 230],
    ["Surface-Silk Scrap", 0.1],
    ["Survey of the Neath's Bones", 0.50],  // via Hinterland Scrip
    ["Sworn Statement", 2.5],
    ["Tailfeather Brilliant as Flame", 2.5],
    ["Tale of Terror!!", 0.5],
    ["Talkative Rattus Faber", 0.5],
    ["Tantalising Possibility", 0.1],
    ...
    ["Thirsty Bombazine Scrap", 2.5],
    ["Thrilling Short Story", 50],
    ["Tin of Zzoup", 2.5],
    ["Tinned Ham", 63.5],
    ...
    ["Unearthly Fossil", 2.5],
    ["Unidentified Thigh Bone", 0.50],  // via Hinterland Scrip
    ["Unjustifiable Necktie", 75],
    ["Unlawful Device", 12.5],
    ["Unloved Short Story", 1],
    ["Unprovenanced Artefact", 2.5],
    ["Unscrupulous Raven Advisor", 40],
    ["Unusual Love Story", 0.5],
    ["Use of Villains", 6],
    ["Veils-Velvet Scrap", 1560],
    ["Venge-Rat Corpse", 0.5],
    ["Venom-Ruby", 0.1],
    ["Venom-Ruby Lure", 6.25],
    ["Vestige of a Starlit Reverie", 312.5],
    ["Vial of Cantigaster Venom", 312.5],
    ["Vial of Masters' Blood", 1562.6],
    ["Vial of Tears of the Bazaar", 312.5],
    ["Vienna Opening", 5 * 0.50],  // via Hinterland Scrip
    ["Virginia's Spare Pillbox Hat", 35],
    ["Vision of the Surface", 0.5],
    ["Vital Intelligence", 12.5],
    ["Vitreous Almanac", 12.5],
    ["Volume of Collated Research", 2.5],
    ["Voracious Glove", 57.6],
    ["Wary Raven Advisor", 9],
    ["Waswood Almanac", 312.5],
    ["Weasel of Woe", 100],
    ["Whirring Contraption", 6],
    ["Whisper-Satin Scrap", 0.5],
    ["Whispered Hint", 0.01],
...
export {ITEM_PRICES_BY_ID, ITEM_PRICES_BY_NAME};
